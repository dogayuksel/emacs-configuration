...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dumb-jump company-tern company helm-c-yasnippet yasnippet helm-ag bind-key auto-compile try expand-region aggressive-indent hungry-delete avy which-key rainbow-mode dash-at-point sourcemap org-pomodoro helm synonyms yaml-mode benchmark-init bookmark+ dired+ sass-mode jade-mode coffee-mode flycheck-flow org-gcal web-mode visual-fill-column use-package undo-tree swiper smartparens scss-mode popwin org-bullets org neotree multiple-cursors mmm-mode magit json-mode impatient-mode iedit helm-descbinds helm-bibtex flycheck exec-path-from-shell elpy drag-stuff badwolf-theme auto-complete airline-themes))))
