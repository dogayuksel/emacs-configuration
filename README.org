...
** evil-magit
** evil-collection
   evil-bindings for common packages
** evil-escape
   [[https://github.com/syl20bnr/evil-escape][link to repo]]
** nlinum-relative
   display relative line numbers
** browse-kill-ring
   paste by selecting from a buffer that lists the items in the kill ring
** all-the-icons-dired
